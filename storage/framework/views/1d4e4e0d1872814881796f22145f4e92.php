...
<div class="container py-4">
    ...
    <div class="row mb-4">
        <div class="col-md-4 d-flex">
            ...
            <a href="<?php echo e(route('area.tensor')); ?>" class="btn btn-dark rounded-0 pt-2 pb-0" style="border-top-left-radius: 0; border-bottom-left-radius: 0;">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\mmois\Documents\GitHub\Apropped\resources\views/vendedor/index.blade.php ENDPATH**/ ?>