<?php $__currentLoopData = $productos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $producto): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
    <div class="col-md-4 producto-item"
        ...
        <div class="card h-100">
            ...
            <img src="<?php echo e($imagenPrincipal ? asset('storage/' . $imagenPrincipal->ruta) : asset('images/default.jpg')); ?>"
                 class="card-img-top pt-2"
                 alt="<?php echo e($producto->nombre); ?>">

            <div class="card-body">
                <h5 class="card-title"><?php echo e($producto->nombre); ?></h5>
                <p class="card-text">Stock: <?php echo e($producto->stock." - Precio: S/. ".$producto->precio); ?></p>
                <div class="d-grid gap-2">
                    <button class="btn btn-info btn-sm btn-ver-imagenes" data-id="<?php echo e($producto->id); ?>">
                        <i class="fas fa-images me-1"></i> Ver Imagen
                    </button>
                    <button class="btn btn-warning btn-sm btn-ver-detalles" data-id="<?php echo e($producto->id); ?>">
...
<?php /**PATH C:\Users\mmois\Documents\GitHub\Apropped\resources\views/vendedor/lista.blade.php ENDPATH**/ ?>